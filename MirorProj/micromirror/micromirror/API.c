 ...
 */
{
    ...
    if ((pMsg->text.cmd == 0x25) || (pMsg->text.cmd == 0x26) ||
            (pMsg->text.cmd == 0x1A2B) || (pMsg->text.cmd == 0x1A2D))
    {
        ackRequired = FALSE;
 ...
 *
 * @param   pulseWidthUS - Minimum pulse width in microseconds
 *
 * @return  0 = PASS    <BR>
 *          -1 = FAIL  <BR>
 *
 ...
 * This API reads the active DMD blocks
 *
 * @param   [out] pulseWidthUS - Minimum pulse width in microseconds
 *
 * @return  0 = PASS    <BR>
 *          -1 = FAIL  <BR>
 *
